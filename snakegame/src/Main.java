...
class SnakeGame extends JPanel implements ActionListener {
    ...
    private final int DOT_SIZE = 20; // Changed from 10 to 20
    private final int ALL_DOTS = 900;
    private final int RAND_POS = 14; // Adjusted for larger DOT_SIZE
    ...
    private void checkApple() {
        ...
        if ((x[0] >= apple_x) && (x[0] < apple_x + DOT_SIZE) && (y[0] >= apple_y) && (y[0] < apple_y + DOT_SIZE)) {
            dots++;
            score++;
            locateApple();
        }
